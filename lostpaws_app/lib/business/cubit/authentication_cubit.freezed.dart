...
class _$_AuthenticationState extends _AuthenticationState {
  ...
  @override
  String toString() {
    return 'AuthenticationState(email: $email, password: $password, status: $status, autoValidate: $autoValidate, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, status, autoValidate, errorMessage);
